...
class MakeStreamableSpec(unittest.TestCase):
  ...
  def test_make_streamable_multi_dim(self):
    values1 = Stream(tf.constant([[1, 2], [3, 4], [5, 4], [3, 6], [1, 7], [9, 4]]))
    values2 = Stream(tf.constant([[5, 3], [7, 4], [3, 2], [5, 8], [3, 3], [1, 4]]))
